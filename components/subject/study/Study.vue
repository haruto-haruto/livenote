...
import e_mentalmap from './e_mentalmap';
...
export default defineComponent ({
    name:'sturdy',
    components: {
        e_mentalmap,comingsoon1,comingsoon2,comingsoon3,comingsoon4,comingsoon5,comingsoon6,comingsoon7,
    },
    setup() {
        const current = ref('e_mentalmap');
        const tabs = {
            'e_mentalmap':'メンタルマップ',
