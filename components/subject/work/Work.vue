...
import gamefication from '~/components/subject/work/e_gamefication';
...
export default defineComponent ({
    name:'work',
    components: {
        gamefication,comingsoon1,comingsoon2,comingsoon3,comingsoon4,comingsoon5,comingsoon6,comingsoon7,
    },
    setup() {
        const current = ref('gamefication');
        const tabs = {
