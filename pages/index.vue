    ...
    <div class="overflow-y-auto py-4 px3 rounded-lg bg-[#e0e0e0] dark:bg-gray-800 totu-morphism" >
      ...
      <ul class="space-y-2">
        <li v-for="tab in tabNames">
          <a href="#" v-on:click="onclick(tab)" class="flex items-center p-2 text-base font-nomal text-glay-900 rounded-lg hover:bg-gray-100 dark:text-white
           dark:hover:bg-gray-700 bg-[#e0e0e0]">
      ...
      <ul class="pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700">
         ...
         <li>
            <a href="/home" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100
             dark:hover:bg-gray-700 dark:text-white group">
...
import Liver from '../components/liver/Liver.vue'
